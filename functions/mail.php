...
function tin_mail_template($type,$content){
	...
	if(!empty($logo)) {$html .= '<img style="vertical-align:middle;background: #00d6ac;" src="'.$logo.'" height="35" border="0">';}else{$html .= '<span style="vertical-align:middle;font-size:20px;line-height:32px;">'.$blogname.'</span>';}
