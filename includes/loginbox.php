...
<div id="sign" class="sign">
    ...
    <div class="other-sign">
      ...
      <div><a class="qqlogin" href="<?php echo home_url('/?connect=qq&action=login&redirect='.urlencode(tin_get_redirect_uri())) ?>"><i class="fa fa-qq"></i><span><?php _e('Q Q 登 录','tinection'); ?></span></a></div>
	  <?php } ?>
	  <?php if(ot_get_option('tin_open_weibo')=='on') { ?>
	  <div><a class="weibologin" href="<?php echo home_url('/?connect=weibo&action=login&redirect='.urlencode(tin_get_redirect_uri())) ?>"><i class="fa fa-weibo"></i><span><?php _e('微 博 登 录','tinection'); ?></span></a></div>
	  <?php } ?>
    </div>
	<?php } ?>
    </div>
